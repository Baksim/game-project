...
def show(game, outcome, nicks, rating):
    ...
    while running:
        ...
        otcm = game.fonts["text"].render(str(outcome), True, (0, 0, 0))
        ...
        game.screen.blit(otcm, otcm.get_rect(center=(display.left + display.width/2, display.top + display.height/4)))
